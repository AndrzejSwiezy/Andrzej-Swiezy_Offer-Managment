...
$(document).ready(function(){
    ...
    function getOneOffer(id){
        $.ajax({
            ...
            success: function(data) {
                ...
                $($("#updateForm")[0].updateDescriptin).val(data.data.description);
                $("#updateForm").show();
            }
        });
    }
    ...
    $("#updateOffer").on("click", function(e) {
        ...
        $.ajax({
            ...
            contentType: 'application/json',
            dataType: 'json',
            url: 'https://alfa.propertygrouppoland.pl/q/andrzejswiezy/update/' + id,
            data: JSON.stringify(data),
        });

        udpateOffer($($("#updateForm")[0].id).val(), data);
