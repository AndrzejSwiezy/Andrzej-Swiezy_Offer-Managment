        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data.data, function(i, data){
                    $('#tableBody').append("<tr><td>" + data.id + "</td><td>" + data.city + "</td><td>" + data.street + "</td><td>" + data.property + "</td><td>" + data.apartment + "</td><td>" + data.price + " PLN </td><td>" + data.type + "</td><td>" + data.description + "</td><td><i class='far fa-edit editOff' data-offid='"+ data.id +"'></i><i class='fas fa-trash deleteOff' data-offid='"+ data.id +"'></i></td></tr>");                         
                });
                loadButtons();
            }
        });    
